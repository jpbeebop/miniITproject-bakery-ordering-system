<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="portfolioStyling.css">
    ...
    <body>
        <header>
                <nav class="headerabc">
                    <ul class="header123">
                        ...
                        <li class="headernav"><a href="login2.php">Login/Signup</a></li>
                    </ul>
                </nav>
        ...
        <div id="container">
            <a href="#oreo-cake" class="cake"><img src="images/oreo_cake.jpg" alt="Oreo Cake"></a>
